...
from torch.optim import Optimizer # import for EpochBasedRunnerAmp from focalnet
...
# -------------------------------------------------
# EpochBasedRunnerAmp from Focalnet/detection/mmcv_custom/runner/epoch_based_runner.py
